...
export class Document {
   ...
   */
  fitToWindow(containerWidth: number, containerHeight: number, padding: number = 40): void {
   ...
   */
  static deserialize(state: DocumentState, brushEngine?: BrushEngine): Document {
