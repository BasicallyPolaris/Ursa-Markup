...
export function TabBar() {
  const { documents, activeDocumentId, switchTab, closeTab, addTab } = useTabManager();
  ...
  return (
    <div className="flex items-center gap-1 px-2 py-1 bg-toolbar-bg border-b border-toolbar-border overflow-x-auto flex-shrink-0">
      {documents.map((tab) => {
        ...
        return (
          <div
            ...
            className={cn(
              "group flex items-center gap-2 px-3 py-1.5 min-w-[120px] max-w-[200px] rounded-t-md cursor-pointer select-none transition-all relative",
              isActive
